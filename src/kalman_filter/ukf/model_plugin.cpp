...
std::shared_ptr<kalman_filter::ukf::model_plugin_t> model_plugin_t::load(const std::string& path)
{
    return std::dynamic_pointer_cast<kalman_filter::ukf::model_plugin_t>(model_plugin_t::load_base(path));
}